...
test_iterations: list[tuple[list[int], int, int]] = [
...
def test_basic_find_longest_sequence(
    ...
    (source_numbers, expect_start_number, expect_end_number) = (
        sample_valid_numbers_and_solutions_set
    )
    id_first, id_second = find_longest_sequence(in_array=source_numbers)
